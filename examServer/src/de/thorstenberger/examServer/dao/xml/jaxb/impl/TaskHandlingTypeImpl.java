...
+"\u0007\u0001pq\u0000~\u0000\nq\u0000~\u0000\u0011q\u0000~\u0000$q\u0000~\u0000\u0007q\u0000~\u0000\u0005q\u0000~\u0000\u0013q\u0000~\u0000\u0014x"));
    ...
    public static class TaskletTypeImpl implements de.thorstenberger.examServer.dao.xml.jaxb.TaskHandlingType.TaskletType, com.sun.xml.bind.JAXBObject, de.thorstenberger.examServer.dao.xml.jaxb.impl.runtime.UnmarshallableObject, de.thorstenberger.examServer.dao.xml.jaxb.impl.runtime.XMLSerializable, de.thorstenberger.examServer.dao.xml.jaxb.impl.runtime.ValidatableObject
    {
            ...
            throws org.xml.sax.SAXException
        {
            ...
            int idx5 = 0;
            final int len5 = ((_Flag == null)? 0 :_Flag.size());
            int idx6 = 0;
            ...
            int idx10 = 0;
            final int len10 = ((_StudentAnnotation == null)? 0 :_StudentAnnotation.size());
            int idx11 = 0;
            final int len11 = ((_CorrectorHistory == null)? 0 :_CorrectorHistory.size());
            while (idx11 != len11) {
                ...
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _CorrectorHistory.get(idx11 ++)), "CorrectorHistory");
                context.endElement();
            }
            while (idx5 != len5) {
                ...
                context.endAttributes();
                try {
                    context.text(((java.lang.String) _Flag.get(idx5 ++)), "Flag");
                } catch (java.lang.Exception e) {
                    de.thorstenberger.examServer.dao.xml.jaxb.impl.runtime.Util.handlePrintConversionException(this, e, context);
                }
                context.endElement();
            ...
            while (idx10 != len10) {
                ...
                context.endAttributes();
                context.childAsBody(((com.sun.xml.bind.JAXBObject) _StudentAnnotation.get(idx10 ++)), "StudentAnnotation");
                context.endElement();
            }
...
+"\u0001pq\u0000~\u0000\u0012q\u0000~\u0000Wq\u0000~\u0000eq\u0000~\u0000\u0080q\u0000~\u0000\u0019q\u0000~\u0000Yq\u0000~\u0000gq\u0000~\u0000uq\u0000~\u0000\u0082q\u0000~\u0000,q\u0000~\u0000Rq\u0000~"
+"\u0000\rq\u0000~\u0000`q\u0000~\u0000\fq\u0000~\u0000nq\u0000~\u0000\u000bq\u0000~\u0000|q\u0000~\u0000\u0089q\u0000~\u0000sq\u0000~\u0000\bq\u0000~\u0000\nq\u0000~\u0000\u000fq\u0000~\u0000Vq\u0000~"
+"\u0000dq\u0000~\u0000\u0007q\u0000~\u0000Hq\u0000~\u0000Gq\u0000~\u0000\u0005q\u0000~\u0000\u001bq\u0000~\u0000[q\u0000~\u0000iq\u0000~\u0000wq\u0000~\u0000\u0084q\u0000~\u0000\u008dq\u0000~\u0000\tq\u0000~"
+"\u0000\u0006q\u0000~\u0000\u001cq\u0000~\u0000\\q\u0000~\u0000jq\u0000~\u0000xq\u0000~\u0000\u0085q\u0000~\u0000Jq\u0000~\u0000rx"));
            }
            return new com.sun.msv.verifier.regexp.REDocumentDeclaration(schemaFragment);
        }
