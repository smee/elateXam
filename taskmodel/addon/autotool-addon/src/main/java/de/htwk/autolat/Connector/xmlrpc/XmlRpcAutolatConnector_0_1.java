...
import de.htwk.autolat.Connector.AutolatConnectorRpcFault;
...
import de.htwk.autolat.Connector.types.ServerInfo;
...
import de.htwk.autolat.Connector.xmlrpc.parse.DocumentedParser;
import de.htwk.autolat.Connector.xmlrpc.parse.DoubleParser;
import de.htwk.autolat.Connector.xmlrpc.parse.EitherParser;
import de.htwk.autolat.Connector.xmlrpc.parse.InstanceParser;
import de.htwk.autolat.Connector.xmlrpc.parse.ListParser;
import de.htwk.autolat.Connector.xmlrpc.parse.PairParser;
import de.htwk.autolat.Connector.xmlrpc.parse.Parser;
import de.htwk.autolat.Connector.xmlrpc.parse.ServerInfoParser;
import de.htwk.autolat.Connector.xmlrpc.parse.SignedParser;
import de.htwk.autolat.Connector.xmlrpc.parse.StringParser;
import de.htwk.autolat.Connector.xmlrpc.parse.TaskDescriptionParser;
import de.htwk.autolat.Connector.xmlrpc.parse.TaskTreeParser;
import de.htwk.autolat.Connector.xmlrpc.parse.TripleParser;
import de.htwk.autolat.Connector.xmlrpc.serialize.InstanceSerializer;
import de.htwk.autolat.Connector.xmlrpc.serialize.PairSerializer;
import de.htwk.autolat.Connector.xmlrpc.serialize.Serializer;
import de.htwk.autolat.Connector.xmlrpc.serialize.SignedSerializer;
import de.htwk.autolat.Connector.xmlrpc.serialize.StringSerializer;
 ...
 */
public class XmlRpcAutolatConnector_0_1 implements AutolatConnector_0_1
{
	...
	private void checkServerVersion(URL url) throws AutolatConnectorException
	{
		...
		if (vers.getMajor() != 0 || vers.getMinor() < 1)
	 ...
	 */
	public XmlRpcAutolatConnector_0_1(URL url, int timeout) throws AutolatConnectorException
	{
	 ...
	 * @throws AutolatConnectorException
	 */
	public XmlRpcAutolatConnector_0_1(URL url) throws AutolatConnectorException
	{
	...
	static private final Parser<TaskDescription> taskDescriptionParser =
		TaskDescriptionParser.getInstance();

	public TaskDescription getTaskDescription(String task) throws AutolatConnectorException
	{
		try {
			Object[] args = {
			...
			// System.err.println(result);
			return taskDescriptionParser.parse(result);
		}
		catch (Exception e) {
