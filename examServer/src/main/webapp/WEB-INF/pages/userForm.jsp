    ...
    <li>
        ...
        <div class="group">
            ...
            <div>
                ...
                <p><examServer:label key="userForm.addressForm.province"/></p>
            </div>
            <div class="left">
                ...
                <p><examServer:label key="userForm.addressForm.postalCode"/></p>
            </div>
            <div>
                <examServer:country name="countries" toScope="page"/>
                ...
                <p><examServer:label key="userForm.addressForm.country"/></p>
            </div>
        </div>
    </li>
     -->
