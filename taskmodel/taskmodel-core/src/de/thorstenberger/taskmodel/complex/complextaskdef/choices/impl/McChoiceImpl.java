 ...
 *
 */
public class McChoiceImpl implements Choice {

	private de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.McTaskBlockType.Choice choice;
	
	/**
	 * 
	 */
	public McChoiceImpl( de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.McTaskBlockType.Choice choice ) {
		this.choice = choice;
	}
	...
	public List<SubTaskDef> getSubTaskDefs() {
		...
		Iterator it = choice.getMcSubTaskDef().iterator();
		while( it.hasNext() ){
			ret.add( new McSubTaskDefImpl( (McSubTaskDef) it.next() ) );
		}
		return ret;
	}
