 ...
 *
 */
public class MappingChoiceImpl implements Choice {

	private de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.MappingTaskBlockType.Choice choice;

	/**
	 * @param choice
	 */
	public MappingChoiceImpl(de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.MappingTaskBlockType.Choice choice) {
		this.choice = choice;
	}
	...
	public List<SubTaskDef> getSubTaskDefs() {
		...
		Iterator it = choice.getMappingSubTaskDef().iterator();
		while( it.hasNext() ){
			ret.add( new MappingSubTaskDefImpl( (MappingSubTaskDef) it.next() ) );
		}
		return ret;
	}
