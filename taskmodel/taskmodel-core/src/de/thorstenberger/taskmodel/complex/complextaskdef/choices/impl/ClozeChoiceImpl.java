 ...
 *
 */
public class ClozeChoiceImpl implements Choice {

	private de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.ClozeTaskBlockType.Choice choice;
	
	/**
	 * @param choice
	 */
	public ClozeChoiceImpl(de.thorstenberger.taskmodel.complex.jaxb.ComplexTaskDefType.CategoryType.ClozeTaskBlockType.Choice choice) {
		this.choice = choice;
	}
	...
	public List<SubTaskDef> getSubTaskDefs() {
		...
		Iterator it = choice.getClozeSubTaskDef().iterator();
		while( it.hasNext() ){
