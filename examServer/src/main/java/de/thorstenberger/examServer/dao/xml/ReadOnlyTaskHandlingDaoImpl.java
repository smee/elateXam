...
/**
 * Readonly version of {@link TaskHandlingDao}.
 *
 * @author Steffen Dienst
 *
 */
public class ReadOnlyTaskHandlingDaoImpl extends TaskHandlingDaoImpl {

    /**
     * @param examServerManager
     */
    public ReadOnlyTaskHandlingDaoImpl(ExamServerManager examServerManager) {
        super(examServerManager);
    }
